...
public class MainActivity extends AppCompatActivity {
    ...
    private void buildDialog() {
        ...
        final EditText rating = view.findViewById(R.id.ratingIn);
        ...
        builder.setTitle("Enter Details")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        addCard(name.getText().toString(),address.getText().toString(),phone.getText().toString(), description.getText().toString(), rating.getText().toString(), vegetarian.isChecked(), vegan.isChecked(), organic.isChecked(), european.isChecked(), asian.isChecked(), other.isChecked());
                    }
                })
    ...
    private void addCard(String name, String address,String phone, String description, String rating, boolean vegan, boolean vegetarian, boolean organic, boolean european, boolean asian, boolean other) {
